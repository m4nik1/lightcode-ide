...
export type RequestFor<M extends ClientRequest["method"]> = Extract<ClientRequest, {
    method: M;
}>;
export type ParamsFor<M extends ClientRequest["method"]> = RequestFor<M> extends {
    params: infer Params;
} ? Params : never;
//# sourceMappingURL=protocol-map.d.ts.map